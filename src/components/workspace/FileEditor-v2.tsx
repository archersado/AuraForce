...
export function FileEditor({
  ...
  console.log('[FileEditor-v2] Props:', {
    path,
  ...
  useEffect(() => {
    console.log('[FileEditor-v2] Updating editor content:', content?.length || 0, 'bytes');
  ...
  }, [editorContent, onSave, path, workspaceRoot]);
  ...
  const renderContent = () => {
    ...
    if (isMarkdown) {
      console.log('[FileEditor-v2] Rendering MarkdownEditor with', editorContent.length, 'bytes');
      return (
        <MarkdownEditor
