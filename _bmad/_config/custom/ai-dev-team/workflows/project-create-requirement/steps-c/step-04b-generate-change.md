---
name: 'step-04b-generate-change'
description: 'Generate and save the change requirements document'
...
# Step 4B: Generate Change Requirements Document

## STEP GOAL:
To generate and save the change requirements document with all collected information.
...
## CONTEXT BOUNDARIES:
- Available context: Collected requirements from step-03b, mode = 'change'
- Focus: Generate and save change requirements document
- Limits: Use only collected information, don't add details not discussed
- Dependencies: Step 03b complete, mode = 'change'
...
Display: "**【Step 4 of 6】Generate Change Requirements Document**"
...
```yaml
---
stepsCompleted: ['step-01-init', 'step-02-confirm-mode', 'step-03b-gather-change', 'step-04b-generate-change']
date: {{current_date}}
user_name: {{user_name}}
mode: 'change'
...
- Fill in all collected sections: 描述, 范围
...
- Mode: change
- Sections Included: 需求名称, 描述, 范围"

### 6. Present Continue Menu

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[Step 4B] Document Generated
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Document Status:
  ✅ Change requirements document created and saved
